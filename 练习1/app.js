...
// 2工厂模式创建对象 -- 构造函数创建对象
// // 工厂
// function fun1(name,age,c){
//     var obj=new Object()
//     obj.name=name
//     obj.age=age
//     obj.c=c
// }
// var fn1=new fun1('何润昊',20,'傻子')
// // 构造函数
// function Fun2() {
// }
// var obj=Fun2()
// var obj=new Fun2()
// 3将对象造个句子
// let obj: { name: string, age: number } = { name: '何润昊', age: 18 }
// document.body.innerHTML=`我叫${obj.name}年龄${obj.age}`
...
// sort()正序
// reverse()倒序
// 改变原数组：pop() push() shift() unshift() reverse() sort() splice()
// 5为什么类型断言左右是number
// 6函数有哪几种 --总结
/*
方法调用模式
